class InvoiceEditDetails {
  Data? data;
  bool? status;
  String? message;

  InvoiceEditDetails({this.data, this.status, this.message});

  InvoiceEditDetails.fromJson(Map<String, dynamic> json) {
