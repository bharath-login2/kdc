...
class _CallLogsState extends State<CallLogs> {
  ...
  getData() async {
    ...
    logHistory =
        await HttpService.callLogHistory(widget.token,fromdate,todate,assignStaffId);
    if (logHistory != null) {
      setState(() {
        if(isSearch==false){
                ...
                children: [
                  ...
                  Row(
                    children: [
                          ...
                          if (object1.data == true) {
                            ...
                            if (context.mounted) {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => CallLogs(widget.token,widget.name,widget.userId)),
                              );
                            }
                          } else {
                      ...
                      deleteHistoryIds.isNotEmpty? InkWell(
                        onTap: (){
                          showDialog(
                              context: context,
                              builder:
                                              ...
                                              Navigator.push(
                                                ...
                                                MaterialPageRoute(
                                                    builder:
                                                        (context) =>
                                                        CallLogs(
                                                            widget.token,widget.name,widget.userId)),
                                              );
                                            }
                                          }
                                          else {
              ...
              Column(
                children: [
                  ...
                  refresh == false
                      ? Column(
                        children: [
                          Text('${DateFormat('dd-M-yyyy').format(DateTime.fromMillisecondsSinceEpoch(from))} - ${DateFormat('dd-M-yyyy').format(DateTime.fromMillisecondsSinceEpoch(to))} (Last 30 Days)',style: const TextStyle(fontSize: 16,),textAlign: TextAlign.center,),
                          ...
                          itemBuilder: (context, indexStaff) {
                            return InkWell(
                                ...
                                onTap: () {
                                  if (onLongPress == true) {
                                    if (historyIndex.contains(indexStaff)) {
                                      historyIndex.remove(indexStaff);
                                      history.removeWhere(
                                            (item) => mapEquals(
                                            item,
                                            ({
                                ...
                                child: Padding(
                                  ...
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                      color: historyIndex.contains(indexStaff)
                                                    ...
                                                    children: [
                                                      ...
                                                      Padding(
                                                        ...
                                                        const EdgeInsets.only(
                                                            right: 10),
                                                        child: Text(
                                                          '${(Duration(seconds: _callLogEntries.elementAt(indexStaff).duration!))}'
                                                              .split('.')[0]
                                                              .padLeft(8, '0'),
                                                          style: const TextStyle(
                                                              fontSize: 15,
                            ...
                            child: Column(
                              children: [
                                ...
                                Image.asset('assets/main/noCallLog.png',
                                    width: 100,
                                    height: 100,
                                    fit: BoxFit.fill),
                                const SizedBox(height: 20,),
                                const Text('No Calls Found',style: TextStyle(fontSize: 18),)
               ...
               Column(children: [
                logHistory!=null && commonDetails!=null?Column(
                  children: [
                    Padding(
                      padding:
                    ...
                    ListView.builder(
                        shrinkWrap: true,
                        itemCount: logHistory!.data!.length,
                        physics: const NeverScrollableScrollPhysics(),
                          ...
                          return InkWell(
                              onLongPress: () {
                                setState(() {
                                  ...
                                  deleteHistoryIds.add(logHistory!.data![index].id.toString());
                                });
                              },
                              onTap: () {
                                if (onLongPressHistory == true) {
                                  if (deleteHistoryIds.contains(logHistory!.data![index].id.toString())) {
                                    deleteHistoryIds.remove(logHistory!.data![index].id.toString());
                              ...
                              child: Padding(
                                ...
                                child: Container(
                                  width: MediaQuery.of(context).size.width * 1,
                                  decoration: BoxDecoration(
                                    color:  deleteHistoryIds.contains(logHistory!.data![index].id.toString())
                                        ? Colors.blueGrey.shade200
                                        : Colors.white,
                                    boxShadow: const [
                                      BoxShadow(
                                              ...
                                              children: [
                                                ...
                                                const SizedBox(
                                                 ...
                                                 Column(
                                                  ...
                                                  CrossAxisAlignment.start,
                                                  children: [
                                                    Text(logHistory!.data![index].name.toString(),
                                                      style: const TextStyle(
                                                          fontSize: 16,
                                                          fontWeight:
                                                          FontWeight.w500),
                                                    ...
                                                    Text(logHistory!.data![index].phoneNumber.toString(),
                                                      style: const TextStyle(
                                                          fontSize: 15,
                                                          fontWeight:
                                                          FontWeight.w400),
                                                  ...
                                                  children: [
                                                    ...
                                                    Padding(
                                                      ...
                                                      const EdgeInsets.only(
                                                          right: 10),
                                                      child: Text(
                                                        logHistory!.data![index].duration.toString()
                                                            .split('.')[0]
                                                            .padLeft(8, '0'),
                                                        style: const TextStyle(
                                                            fontSize: 15,
                    ...
                    Center(
                      child: Lottie.asset('assets/main/no_history.json',
                          fit: BoxFit.fill),
                    )
                  ],
                ):
