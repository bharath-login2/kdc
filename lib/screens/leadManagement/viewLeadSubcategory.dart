...
import 'package:kdc_chitty_mainnew/models/lead_management/viewLeadSubCategoryModel.dart';
import 'package:kdc_chitty_mainnew/screens/leadManagement/viewLeadCategory.dart';
...
class ViewLeadSubCategory extends StatefulWidget {
  ...
  bool deleteLeads;
  String categoryId;
  ViewLeadSubCategory(this.token,this.createLeads,this.updateLeads,this.deleteLeads,this.categoryId, {super.key});
  @override
...
class _ViewLeadSubCategoryState extends State<ViewLeadSubCategory> {
  ...
  getData() async {
    ...
    viewSubLeadsCategory = await HttpService.viewLeadsSubCategory(widget.token,widget.categoryId);
    ...
    return RefreshIndicator(
        ...
        child: result==true?WillPopScope(
          ...
          child: Scaffold(
                                                ...
                                                child: RawMaterialButton(
                                                  onPressed: () async {
                                                    if(subcategory.text.isEmpty){
                                                      ...
                                                      AddLeadSubCategoryModel addCategory=await HttpService.addLeadSubCategory(widget.token,subcategory.text,widget.categoryId);
                                                        ...
                                                        if (context
                                                          ...
                                                          MaterialPageRoute(
                                                              builder: (context) => ViewLeadSubCategory(
                                                                  ...
                                                                  widget.createLeads,
                                                                  widget.updateLeads,
                                                                  widget.deleteLeads,widget.categoryId)),
                                                        );
                                                        }
                                                      }
                                                      else{
            ...
            Container(
              child: viewSubLeadsCategory!.data!.isNotEmpty?ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return Padding(
                      ...
                      child: SizedBox(height:60,child: Center(child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Text(viewSubLeadsCategory!.data![index].leadSubCategory.toString(),style: const TextStyle(fontSize: 16,fontWeight: FontWeight.w400)),
                          Row(
                            children: [
                              widget.updateLeads==true?InkWell(
                                  onTap: (){
                                    subcategoryEdit.text=viewSubLeadsCategory!.data![index].leadSubCategory.toString();
                                    showGeneralDialog(
                                      barrierLabel: "showGeneralDialog",
                                      barrierDismissible: true,
                                      barrierColor: Colors.black.withOpacity(0.6),
                                                        ...
                                                        child: RawMaterialButton(
                                                          onPressed: () async {
                                                            if(subcategoryEdit.text.isEmpty){
                                                              ...
                                                              {
                                                                Common.toastMessaage(
                                                                    editSubCategory.message, Colors.green);
                                                                if (context
                                                                    .mounted) {
                                                                  Navigator.push(
                                                                  context,
                                                                ...
                                                                Common.toastMessaage(
                                                                    editSubCategory.message, Colors.red);
                                                                if (context
                                                                    .mounted) {
                                                                  Navigator.of(context).pop();
                                                                }
                              ...
                              widget.deleteLeads==true?InkWell(
                                  onTap: (){_deleteSubCategory(context,viewSubLeadsCategory!.data![index].leadSubCategoryId);},
