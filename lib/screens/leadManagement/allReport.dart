...
class AllReport extends StatefulWidget {
  ...
  AllReport(this.token,this.editLead,this.deleteLead,this.cloudCall,{this.pageName,this.page,this.pageSize,this.checkedCategoryItems,this.checkedCategoryItemsName,
    this.checkedCallResultItems,this.checkedCallResultItemsName,this.checkedPriorityItems,this.checkedPriorityItemsName,
    this.checkedAssignedStaffItems,this.checkedAssignedStaffItemsName,this.checkedCreatedStaffItems,this.checkedCreatedStaffItemsName,Key? key}) : super(key: key);
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                      ...
                                                      content: ListView.builder(
                                                        ...
                                                        itemBuilder: (context, ind) {
                                                          return CheckboxListTile(
                                                            ...
                                                            value: checkedCategoryItems!.contains(
                                                              ...
                                                              if (value == true) {
                                                                ...
                                                                setState(() {
                                                                  checkedCategoryItems!.remove(
                                                                      commonDetails!.data!.leadCategory![ind].leadCategoryId.toString());
                                                                  checkedCategoryItemsName!.remove(
                                                                      commonDetails!.data!.leadCategory![ind].leadCategory.toString());
                                                ...
                                                child: Container(
                                                  ...
                                                  child:  checkedCategoryItems!.isEmpty?const Padding(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                      ...
                                                      content: ListView.builder(
                                                        ...
                                                        itemBuilder: (context, ind) {
                                                          return CheckboxListTile(
                                                            ...
                                                            value: checkedCallResultItems!.contains(
                                                                commonDetails!.data!.callResult![ind].callResultId.toString())
                                                                ? true
                                                                : false,
                                                            onChanged: (bool? value) {
                                                              if (value == true) {
                                                                setState(() {
                                                                  ...
                                                                  checkedCallResultItemsName!.add(
                                                                      commonDetails!.data!.callResult![ind].callResult.toString());
                                                                ...
                                                                setState(() {
                                                                  checkedCallResultItems!.remove(
                                                                      commonDetails!.data!.callResult![ind].callResultId.toString());
                                                                  checkedCallResultItemsName!.remove(
                                                                      commonDetails!.data!.callResult![ind].callResult.toString());
                                                ...
                                                child: Container(
                                                  ...
                                                  child:  checkedCallResultItems!.isEmpty?const Padding(
                                                      padding: EdgeInsets.only(left: 10,top: 15,bottom:10),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                        ...
                                                        Axis.horizontal,
                                                        itemCount:
                                                        checkedCallResultItemsName!.length,
                                                        itemBuilder: (context, i) {
                                                          return Padding(
                                                            padding:
                                                            const EdgeInsets.only(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                        ...
                                                        itemBuilder: (context, ind) {
                                                          return CheckboxListTile(
                                                            title: SizedBox(
                                                              width: 200,
                                                              child: Text(
                                                                commonDetails!.data!.priority![ind].priority.toString(),
                                                                style: const TextStyle(
                                                                    color: Colors.black,
                                                                    fontWeight:
                                                                    FontWeight.w400,
                                                            ...
                                                            value: checkedPriorityItems!.contains(
                                                                commonDetails!.data!.priority![ind].priorityId.toString())
                                                                ? true
                                                                : false,
                                                            onChanged: (bool? value) {
                                                              if (value == true) {
                                                                setState(() {
                                                                  checkedPriorityItems!.add(commonDetails!.data!.priority![ind].priorityId.toString());
                                                                  checkedPriorityItemsName!.add(
                                                                      commonDetails!.data!.priority![ind].priority.toString());
                                                                ...
                                                                setState(() {
                                                                  checkedPriorityItems!.remove(
                                                                      commonDetails!.data!.priority![ind].priorityId.toString());
                                                                  checkedPriorityItemsName!.remove(
                                                                      commonDetails!.data!.priority![ind].priority.toString());
                                                ...
                                                child: Container(
                                                  ...
                                                  child:  checkedPriorityItems!.isEmpty?const Padding(
                                                      padding: EdgeInsets.only(left: 10,top: 15,bottom:10),
                                                      child: Text('Priority')
                                                  ):
                                                  Padding(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                        ...
                                                        itemBuilder: (context, ind) {
                                                          return CheckboxListTile(
                                                            ...
                                                            value: checkedAssignedStaffItems!.contains(
                                                                commonDetails!.data!.staff![ind].staffId.toString())
                                                                ? true
                                                                : false,
                                                            onChanged: (bool? value) {
                                                              if (value == true) {
                                                ...
                                                child: Container(
                                                  ...
                                                  child:  checkedAssignedStaffItems!.isEmpty?const Padding(
                                                      padding: EdgeInsets.only(left: 10,top: 15,bottom:10),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                        ...
                                                        Axis.horizontal,
                                                        itemCount:
                                                        checkedAssignedStaffItemsName!.length,
                                                        itemBuilder: (context, i) {
                                                          return Padding(
                                                            padding:
                                                            const EdgeInsets.only(
                                            ...
                                            children: [
                                              ...
                                              InkWell(
                                                      ...
                                                      content: ListView.builder(
                                                        ...
                                                        itemBuilder: (context, ind) {
                                                          return CheckboxListTile(
                                                            ...
                                                            value: checkedCreatedStaffItems.contains(
                                                            ...
                                                            onChanged: (bool? value) {
                                                              if (value == true) {
                                                                setState(() {
                                                                  ...
                                                                  checkedCreatedStaffItemsName.add(
                                                                      commonDetails!.data!.transferStaffs![ind].tranStaffName.toString());
                                                                ...
                                                                setState(() {
                                                                  checkedCreatedStaffItems.remove(
                                                                      commonDetails!.data!.transferStaffs![ind].tranStaffId.toString());
                                                                  checkedCreatedStaffItemsName.remove(
                                                                      commonDetails!.data!.transferStaffs![ind].tranStaffName.toString());
                                                ...
                                                child: Container(
                                                  ...
                                                  child:  checkedCreatedStaffItems.isEmpty?const Padding(
                                                      padding: EdgeInsets.only(left: 10,top: 15,bottom:10),
                                                  ...
                                                  Padding(
                                                    ...
                                                    child: SizedBox(
                                                      ...
                                                      child: ListView.builder(
                                                        ...
                                                        Axis.horizontal,
                                                        itemCount:
                                                        checkedCreatedStaffItemsName.length,
                                                        itemBuilder: (context, i) {
                                                          return Padding(
                                                            padding:
                                                            const EdgeInsets.only(
