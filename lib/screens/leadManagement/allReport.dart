...
class _AllReportState extends State<AllReport> {
  ...
  void getData() async {
    ...
    if (!isLoading) {
      ...
      print('commonDetails: ${commonDetails?.toJson()}'); // Debug print
                                                            ...
                                                            content: ListView.builder(
                                                              ...
                                                              itemBuilder: (context, ind) {
                                                                    ...
                                                                    onChanged:
                                                                        (
                                                                          ...
                                                                          if (value ==
                                                                              true) {
                                                                            setState(() {
                                                                              checkedCallResultItems!.clear();
                                                                              checkedCallResultItemsName!.clear();
                                                                ...
                                                                return CheckboxListTile(
                                                                  ...
                                                                  value:
                                                                      checkedCallResultItems!.contains(
                                                                        commonDetails!
                                                                            .data!
                                                                            .callResult![newInd]
                                                                            .callResultId
                                                            ...
                                                            content: ListView.builder(
                                                              ...
                                                              itemBuilder: (context, ind) {
                                                                return CheckboxListTile(
                                                                  ...
                                                                  value:
                                                                      checkedAssignedStaffItems!.contains(
                                                                        commonDetails!
                                                                            .data!
                                                                            .staff![ind]
                                                                            .staffId
                                                            ...
                                                            content: ListView.builder(
                                                              ...
                                                              itemBuilder: (context, ind) {
                                                                return CheckboxListTile(
                                                                  ...
                                                                  value:
                                                                      checkedCreatedStaffItems.contains(
                                                                        commonDetails!
                                                                            .data!
                                                                            .transferStaffs![ind]
                                                                            .tranStaffId
                                                                                    ...
                                                                                    children: [
                                                                                      ...
                                                                                      Text(
                                                                                        items[index].isCalled ==
                                                                                                false
                                                                                            ? '--'
                                                                                            : items[index].calledDate.toString(),
                                                                                        style: const TextStyle(
                                                                                          fontSize: 13,
                                                                                          color: Colors.black,
                                                                                          fontWeight: FontWeight.w500,
                                                                        ...
                                                                        content: Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            InkWell(
                                                                              onTap: () async {
                                                                                String
                                                                                url = 'tel:+${items[index].contactNumber1}';
                                                                                await launchUrl(
                                                                                  Uri.parse(
                                                                                    url,
                                                                                  ),
