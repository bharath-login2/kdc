...
class _EditLeadState extends State<EditLead> {
  ...
  getData() async {
    ...
    leadDetailsAdditional = await HttpService.listAddonDet(
      widget.token,
      widget.callMasterId,
    );
    ...
    if (commonDetails != null) {
      ...
      setState(() {
        ...
        job.text = leadDetails!.data!.job ?? '';
        location.text = leadDetails!.data!.location ?? '';
        customerNeed.text = leadDetails!.data!.customerNeed ?? '';
        purpose.text = leadDetails!.data!.purpose ?? '';
        challenges.text = leadDetails!.data!.challenges ?? '';
        newObjection.text = leadDetails!.data!.newObjection ?? '';
        if (leadDetails!.data!.googleReviewStatus == 'true') {
          googleReviewYes = true;
        } else if (leadDetails!.data!.googleReviewStatus == 'false') {
          googleReviewNo = true;
        }
        reasonForLostSales.text = leadDetails!.data!.reasonForLostSales ?? '';
        for (
          int i = 0;
                  ...
                  children: [
                                      ...
                                      return InkWell(
                                        onTap: () async {
                                          ...
                                          setState(() {
                                            ...
                                            leadSubTypeId = '';
                                            leadTypeVal.text = commonDetails!
                                                .data!
                                                .leadCategory![ind]
                                                .leadCategory
                                                .toString();
                                  ...
                                  content: ListView.builder(
                                    ...
                                    itemBuilder: (context, ind) {
                                      return InkWell(
                                        onTap: () {
                                          setState(() {
                                            assignUserval.text = commonDetails!
                                                .data!
                                                .staff![ind]
                                                .staffName
                                                .toString();
                                  ...
                                  content: ListView.builder(
                                    ...
                                    itemBuilder: (context, ind) {
                                      return InkWell(
                                        onTap: () {
                                          setState(() {
                                            priorityVal.text = commonDetails!
                                                .data!
                                                .priority![ind]
                                                .priority
                                                .toString();
                    ...
                    ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        return Column(children: [decriptionUi(index)]);
                      },
                      itemCount:
                            ...
                            if (multiBranch == 'true' &&
                              ...
                              EditLeadModel object =
                                  await HttpService.editLeads(
                                    ...
                                    googleReviewStatus: googleReviewYes
                                        ? 'Yes'
                                        : googleReviewNo
                                        ? 'No'
                                        : '',
                                    reasonForLostSales: reasonForLostSales.text,
                                  );
