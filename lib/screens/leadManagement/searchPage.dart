...
class SearchPage extends StatefulWidget {
  ...
  SearchPage(this.token,this.editLead,this.deleteLead,this.cloudCall,this.searchKeyData, {super.key});
  @override
    ...
    return WillPopScope(
      ...
      child: RefreshIndicator(
        ...
        child: result==true?Scaffold(
          ...
          body: search!=null && isSearch==false? SingleChildScrollView(
            child: Column(
              children: [
                ...
                Text('Total Leads : ${search!.data!.totalLeads}',style: const TextStyle(
                    fontSize: 16,
                    fontWeight: FontWeight.bold)),
                const SizedBox(height: 10,),
                search!.data!.details!.isNotEmpty? ListView.builder(
                                                          ...
                                                          children: [
                                                            InkWell(
                                                              onTap: () async {
                                                                ...
                                                                CloudCallModel object1 = await HttpService.addCloudCall(widget.token, search!.data!.details![i].callMasterId.toString(), search!.data!.details![i].contactNumber1);
                ...
                SizedBox(
                  ...
                  child: Column(
                    ...
                    children: [
                     ...
                     searchkey.text!='' && resultFoundSts==true? const Text('No Result Found',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),):const SizedBox(),
                      const SizedBox(height: 10,),
                      searchkey.text!='' && resultFoundSts==true?const Text('Whoops... this information is \n not available for a moment',style: TextStyle(fontSize: 15),):const SizedBox(),
                      searchkey.text!='' && resultFoundSts==true?const SizedBox(height: 25,):const SizedBox(),
                      InkWell(
                        onTap: (){
                          Navigator.of(context).push(
                              MaterialPageRoute(builder: (context) => Dashboard(widget.token)),
