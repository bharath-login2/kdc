...
import 'package:kdc_chitty_mainnew/screens/leadManagement/allReport.dart';
...
class _LeadDetailsState extends State<LeadDetails> {
  ...
  final AudioRecordController audioCreateController = Get.put(
  ...
  listFolderList(token, callMasterId, path) async {
    listFolder = await HttpService.listFolderAndFiles(
      token,
      callMasterId,
      path,
    );
  ...
  listMileStone(token, callMasterId) async {
  ...
  Widget build(BuildContext context) {
    ...
    return WillPopScope(
      onWillPop: () async {
        ...
        } else if (widget.pageName == 'notification') {
          Navigator.of(context).push(
            MaterialPageRoute(builder: (context) => Dashboard(widget.token)),
          );
        } else if (widget.pageName == 'AllLeads') {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => AllReport(
                ...
                // checkedCategoryItems:widget.checkedCategoryItems,
                // checkedCategoryItemsName:widget.checkedCategoryItemsName,
                // checkedCallResultItems:widget.checkedCallResultItems,
                // checkedCallResultItemsName:widget.checkedCallResultItemsName,
                // checkedPriorityItems: widget.checkedPriorityItems,
                // checkedPriorityItemsName:widget.checkedPriorityItemsName,
                // checkedCreatedStaffItems: widget.checkedCreatedStaffItems,
                // checkedCreatedStaffItemsName: widget.checkedCreatedStaffItemsName,
                // checkedAssignedStaffItems:widget.checkedAssignedStaffItems,
                //   checkedAssignedStaffItemsName: widget.checkedAssignedStaffItemsName,
              ),
            ),
          );
        } else if (widget.pageName == 'LeadNotification') {
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => LeadNotificationPage(
                widget.token,
                widget.editLead,
                widget.deleteLead,
                widget.cloudCall,
                                                                        ...
                                                                        child: RawMaterialButton(
                                                                          onPressed: () async {
                                                                            if (staff ==
                                                                              ...
                                                                              LeadTransferModel
                                                                              transfer = await HttpService.leadTransfer(
                                                                                widget.token,
                                                                                widget.callMasterId,
                                                                                staff,
                                                                                transferRemark.text,
                                                                                                        ...
                                                                                                        child: Material(
                                                                                                          child: Column(
                                                                                                            children: [
                                                                                                              ...
                                                                                                              leadDetailsAdditional!.data!.followUpData![index].isReminder ==
                                                                                                                      true
                                                                                                                  ? Align(
                                                                                                                      ...
                                                                                                                      child: Padding(
                                                                                                                        ...
                                                                                                                        child: InkWell(
                                                                                                                          onTap: () async {
                                                                                                                            UnsetReminderModel unsetReminder = await HttpService.unsetReminder(
                                                                                                                              widget.token,
                                                                                                                              leadDetailsAdditional!.data!.followUpData![index].callDetailsId.toString(),
                                                                                                                            );
                                                                                                                            if (unsetReminder.data ==
                                                                                                                                true) {
                                                                                                                              if (mounted) {
                                                                                                                                Common.showProgressDialog(
                                                                                                                                  context,
                                                                                                                ...
                                                                                                                child: RawMaterialButton(
                                                                                                                  onPressed: () async {
                                                                                                                    if (timeBefore.text.isEmpty ||
                                                                                                                      ...
                                                                                                                      UpdateReminderSetting updateReminder = await HttpService.updateReminder(
                                                                                                                        widget.token,
                                                                                                                        leadDetailsAdditional!.data!.followUpData![index].callDetailsId,
                                                                                                                        true,
                                                                                                                        timeBefore.text,
                                                                                                                      );
                                                                                                                      if (updateReminder.status ==
                                                                                                                          true) {
                                                                                                                        Common.toastMessaage(
                                                                                                        ...
                                                                                                        child: RawMaterialButton(
                                                                                                          onPressed: () async {
                                                                                                            if (folderName.text.isEmpty) {
                                                                                                              ...
                                                                                                              CreateFolderModel createFolder = await HttpService.createFolder(
                                                                                                                widget.token,
                                                                                                                widget.callMasterId,
                                                                                                                path +
                                                                                                                    folderName.text,
                                                                                                              ...
                                                                                                              child: RawMaterialButton(
                                                                                                                onPressed: () async {
                                                                                                                  if (fileNameEdit.text.isEmpty) {
                                                                                                                    ...
                                                                                                                    RenameFolderModel createFolder = await HttpService.renameFolder(
                                                                                                                      widget.token,
                                                                                                                      widget.callMasterId,
                                                                                                                      listPath,
                                                                                                                      editableName,
                                                                                    ...
                                                                                    (
                                                                                      ...
                                                                                      return AlertDialog(
                                                                                        ...
                                                                                        actions: [
                                                                                          ...
                                                                                          TextButton(
                                                                                            onPressed: () async {
                                                                                              DeleteFolderAndFileModel deleteFolder = await HttpService.deleteLeadFolderAndFiles(
                                                                                                widget.token,
                                                                                                widget.callMasterId,
                                                                                                deletePath,
                                                                                                rawId,
                                                            ...
                                                            itemBuilder:
                                                                (
                                                                  ...
                                                                  return InkWell(
                                                                    ...
                                                                    onTap: () {
                                                                      fileManagerPermission!.data!.openFile ==
                                                                              true
                                                                          ? setState(() {
                                                                              ...
                                                                              if (listFolder!.data![index].isFolder ==
                                                                                  'Y') {
                                                                                backPath = '${listFolder!.data![index].path}';
                                                                                path = '${listFolder!.data![index].path}/';
                                                                                listPath = '${listFolder!.data![index].path}';
                                                                              } else {
                                                                                listPathAudio = '${listFolder!.data![index].path}';
                                                                              }
                                                                                                              ...
                                                                                                              children: [
                                                                                                                isPlay ==
                                                                                                                    ...
                                                                                                                    ? FloatingActionButton(
                                                                                                                        ...
                                                                                                                        onPressed: () async {
                                                                                                                          isPlay = true;
                                                                                                                          audioCreateController.playVoice(
                                                                                                                            listPathAudio,
                                                                                                                          );
                                                                                                                        },
                                                                          ...
                                                                          GestureDetector(
                                                                                        ...
                                                                                        builder:
                                                                                            (
                                                                                              ...
                                                                                              return AlertDialog(
                                                                                                scrollable: true,
                                                                                                title: Text(
                                                                                                  mileStone!.data!.milestones![i].milestone.toString(),
                                                                                                ),
                                                                                                content: Column(
                                                                                                  children: [
                                                                                                    const SizedBox(
                                                                                                                          ...
                                                                                                                          return CheckboxListTile(
                                                                                                                            ...
                                                                                                                            value:
                                                                                                                                checkedItems.contains(
                                                                                                                                  commonDetails!.data!.transferStaffs![ind].tranStaffId.toString(),
                                                                                                                                )
                                                                                                                                ? true
                                                                                                                                : false,
                                                                                                                            onChanged:
                                                                                                ...
                                                                                                actions: [
                                                                                                  ...
                                                                                                  TextButton(
                                                                                                    onPressed: () async {
                                                                                                      ...
                                                                                                      body = {
                                                                                                        "token": widget.token,
                                                                                                        'leadMasterId': widget.callMasterId,
                                                                                                        'milestone_id': mileStone!.data!.milestones![i].milestoneId.toString(),
                                                                                                        'userid': checkedItems,
                                                                                                        'remarks': remarks.text,
                                                                                                      };
                                                                                                      AddMileStoneModel addMileStone = await HttpService.addMileStone(
                                                                                                        body,
                                                                                                      );
                                                                                                      if (addMileStone.data ==
                                                                                                          true) {
                                                                                                        Common.toastMessaage(
                                                                                                          addMileStone.message,
                                                                                                          Colors.green,
                                                                                                        );
                                                                                                        if (context.mounted) {
                                                                                                          Navigator.push(
                                                                            ...
                                                                            child: Container(
                                                                              ...
                                                                              decoration: BoxDecoration(
                                                                                shape: BoxShape.circle,
                                                                                gradient:
                                                                                    mileStone!.data!.milestones![i].isChecked! // if the checkbox is checked, apply a gradient to the container
                                                                                ...
                                                                                border: Border.all(
                                                                                  color: Colors.grey,
                                                                                  width: 1,
                                                                                ), // add a grey border to the container
                                                                              ),
                                                                              child:
                                                                                  mileStone!.data!.milestones![i].isChecked! // if the checkbox is checked
                                                                                  ? const Icon(
                                                                                      Icons.check,
                                                                                      color: Colors.white,
                                                                                      size: 26,
                                                                  ...
                                                                  builder:
                                                                      (
                                                                        ...
                                                                        return AlertDialog(
                                                                          ...
                                                                          content: const Text(
                                                                            'You are about to delete this Mile stone?',
                                                                          ),
                                                                          actions: [
                                                                            // The "Yes" button
                                                                            TextButton(
                                                                              onPressed: () async {
                                                                                ...
                                                                                DeleteLeadMileStoneModel
                                                                                deleteMilestoneLead = await HttpService.deleteMileStoneLeads(
                                                                                  widget.token,
                                                                                  mileStone!.data!.leadMilestones![i].milestoneId.toString(),
                                                                                );
                                                                                // print(updateAssignStaff.data);
                                                                                if (deleteMilestoneLead.data ==
                                                                                    true) {
                                                                                  if (mounted) {
                                                                                    // print(updateAssignStaff.data);
                                                                                    Navigator.push(
                                                              ...
                                                              ? TextButton(
                                                                  onPressed: () async {
                                                                    ...
                                                                    if (fileName
                                                                      ...
                                                                      UploadAudioRecord
                                                                      uploadAudio = await HttpService.uploadRecord(
                                                                        widget
                                                                            .token,
                                                                        widget
                                                                            .callMasterId,
                                                                    ...
                                                                    onPressed: () async {
                                                                      ...
                                                                      if (fileName
                                                                        ...
                                                                        Common.toastMessaage(
                                                                          ...
                                                                          double.parse(
                                                                            fileManagerPermission!.data!.maxFileSize.toString(),
                                                                          )) {
                                                                        Common.toastMessaage(
                                                                          'Maximum Size 5 MB',
                                                                          Colors
                                                                          ...
                                                                          double.parse(
                                                                            fileManagerPermission!.data!.remainingStorage.toString(),
                                                                          )) {
                                                                        Common.toastMessaage(
                                                                          'Insufficient Storage',
                                                                          Colors
                                ...
                                child: Center(
                                  child: Text(
                                    ...
                                    style: TextStyle(
                                      fontSize: 13,
                                      color:
                                          widget.status.toString() == 'ANSWERED'
                                          ? Colors.green
                                          : Colors.red,
                                      fontWeight: FontWeight.w500,
                                    ),
