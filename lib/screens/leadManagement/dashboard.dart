                                    ...
                                    InkWell(
                                      onTap: () {
                                        Navigator.push(
                                          ...
                                          MaterialPageRoute(
                                              builder: (context) =>
                                                  LeadNotificationPage(widget.token,leadDashboard!
                                                      .data!
                                                      .createLeadCategory!,
                                                      leadDashboard!
                                                          .data!
                                      ...
                                      if (value == 10) {
                                        leadDashboard!.data!
                                          ...
                                          MaterialPageRoute(
                                              builder:
                                                  (context) =>
                                                       CallLogs(widget.token,name,userId)),
                                        ):
                                        _dialogue(context,
                                            'Phone Call Logs');
                                      }
    ...
    selectNotificationStream.stream.listen((String? payload) async {
      await Navigator.of(context).push(MaterialPageRoute<void>(
        builder: (BuildContext context) =>
            LeadDetails(widget.token!, toBoolean(message.data['edit_lead']),
                toBoolean(message.data['delete_lead']),
                toBoolean(message.data['cloud_call']),
                message.data['detail_id'], pageName: 'Dashboard'),
      ));
    });
  }
