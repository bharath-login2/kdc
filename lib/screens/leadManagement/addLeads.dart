...
class _AddLeadsState extends State<AddLeads> {
  ...
  TextEditingController reasonForLostSales =
      TextEditingController(); // Only show if status is 'Lost' or similar? User didn't specify condition, I'll show it always or let user leave blank.
                                      ...
                                      ? Padding(
                                          ...
                                          child: DropdownButtonFormField(
                                            ...
                                            onChanged: (value) async {
                                              ...
                                              commonDetails =
                                                  await HttpService.addLeadCommonData(
                                                    widget.token,
                                                    branchId: branch,
                                                  );
                                              if (commonDetails != null) {
                                      ...
                                      if (globalKey.currentState!.validate()) {
                                        ...
                                        if (connectivityResult ==
                                          ...
                                          if (multiBranch == 'true' &&
                                            ...
                                            checkLeadPhone =
                                                await HttpService.checkLeadPhoneNumber(
                                                  widget.token,
                                                  contactNo.text,
                                                  code,
                                                );
                                                      ...
                                                      actions: [
                                                        ...
                                                        TextButton(
                                                          onPressed: () async {
                                                            ...
                                                            AddLeadModel
                                                            object = await HttpService.addLeads(
                                                              widget.token,
                                                              branch,
                                                              clientName.text,
                                                              leadTypeId,
