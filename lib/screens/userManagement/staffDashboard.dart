    ...
    setState(() {
      ...
      for (int i = 0; i < staffWise!.data!.categoryGraph!.length; i++) {
        data.addAll({
          ...
          staffWise!.data!.categoryGraph![i].categoryCount!
              .toDouble(),
        });
      }
    });
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child:   Center(child: Padding(
                                                        ...
                                                        child: Text(leadDashboard!.data!.missedLeads.toString(),style: const TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                      )),
                                                    ),
                                                  ],
                                                ),
                                                ...
                                                Row(
                                                  ...
                                                  children: [
                                                    ...
                                                    Container(
                                                      ...
                                                      child:   Center(child: Padding(
                                                        padding: const EdgeInsets.all(4),
                                                        child: Text(leadDashboard!.data!.transferLeads.toString(),style: const TextStyle(color: Colors.white,fontWeight: FontWeight.bold),),
                                                      )),
                                                    ),
                                                  ],
                                                ),
                              ...
                              leadDashboard != null ? Padding(
                                  ...
                                  child: Column(
                                    ...
                                    children: [
                                      ...
                                      Text('Staff Dashboard : ${widget.staffName}',style: const TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                                      const SizedBox(height: 20),
                                      Row(
                                        children: [
                                          InkWell(
                                                        ...
                                                        children: [
                                                          ...
                                                          InkWell(
                                                            onTap: () async {
                                                              ...
                                                              LeadProgressbarModel object1 = await HttpService
                                                                  .leadProgressbarStaff(
                                                                  widget.token,
                                                                  fromdate,
                                                                  todate,
                                                                  '1',widget.staffId);
