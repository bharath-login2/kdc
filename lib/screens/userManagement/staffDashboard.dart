...
import 'package:kdc_chitty_mainnew/screens/userManagement/staffViewLeads.dart';
...
class _StaffDashboardState extends State<StaffDashboard> {
  ...
  getData(token, fromDate, toDate) async {
    ...
    leadDashboard = await HttpService.leadDashboardStaff(
      token,
      fromdate,
      todate,
      fromdate1,
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            InkWell(
                                                                              onTap: () async {
                                                                                ...
                                                                                object1 = await HttpService.leadProgressbarStaff(
                                                                                  widget.token,
                                                                                  fromdate,
                                                                                  todate,
                                                                                  '1',
