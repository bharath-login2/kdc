...
import 'package:kdc_chitty_mainnew/screens/userManagement/editStaffPage.dart';
import 'package:kdc_chitty_mainnew/screens/userManagement/staffDashboard.dart';
                                ...
                                child: PopupMenuButton(
                                  // add icon, by default "3 dot" icon
                                    ...
                                    onSelected: (value) {
                                      ...
                                      if (value == 4) {
                                        viewStaff!.data!.createStaff == true
                                            ? Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                              builder: (context) =>
                                            ...
                                            children: [
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () {
                                                    viewStaff!.data!
                                                        .deleteStaff == false || viewStaff!.data!
                                                        .staffList![i]
                                              ...
                                              Padding(
                                                ...
                                                child: InkWell(
                                                  onTap: () {
                                                    viewStaff!.data!
                                                        .deleteStaff == true && viewStaff!.data!
                                                        .staffList![i]
                                              ...
                                              InkWell(
                                                onTap: () {
                                                  viewStaff!.data!
                                                      .updateStaffPassword == true && viewStaff!.data!
                                                      .staffList![i]
