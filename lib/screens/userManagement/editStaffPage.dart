...
import 'package:kdc_chitty_mainnew/models/userManagement/staffDetailsModel.dart';
          ...
          if (staffDetails!.data!.menuList![i].isAvailable == true) {
            for (
              ...
              if (staffDetails!.data!.menuList![i].subMenu![j].isChecked ==
                  true) {
                setState(() {
                  checkedMenuItems.add(
                    staffDetails!.data!.menuList![i].subMenu![j].id,
                  );
                  sts = true;
                });
              } else {
                                            ...
                                            onTap: () async {
                                              if (multiBranch == 'true' &&
                                                ...
                                                editUserBasicDetails =
                                                    await HttpService.editUserBasicData(
                                                      body,
                                                    );
                                      ...
                                      children: [
                                        ...
                                        InkWell(
                                          onTap: () async {
                                            ...
                                            postSubmenu =
                                                await HttpService.postEditStaffSubMenu(
                                                  subMenuBody,
                                                );
                                      ...
                                      children: [
                                                            ...
                                                            children: [
                                                              Expanded(
                                                                child: CheckboxListTile(
                                                                  ...
                                                                  //value:true,
                                                                  value:
                                                                      checkedPermissionItems.contains(
                                                                        staffDetails!
                                                                            .data!
                                                                            .privilages![index]
                                                                            .permission![i]
                                        ...
                                        InkWell(
                                          onTap: () async {
                                            ...
                                            postPermission =
                                                await HttpService.postEditStaffPermission(
                                                  permissionBody,
                                                );
  ...
  void _pickImage() async {
    ...
    try {
      ...
      setState(() async {
        ...
        AddUserImageModel upload = await HttpService.updateUploadImages(
          formData,
        );
        if (upload.data == true) {
      ...
      setState(() async {
        ...
        if (mounted) {
          Navigator.of(context).push(
            MaterialPageRoute(
              builder: (context) =>
                  EditProfilePage(token: widget.token, staffId: widget.staffId),
            ),
          );
        }
      });
