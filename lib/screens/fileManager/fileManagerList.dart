...
import 'package:kdc_chitty_mainnew/screens/fileManager/listFiles.dart';
...
class _FileMangerListState extends State<FileMangerList> {
  ...
  getData() async {
     fileManagerPermissionMain = await HttpService.fileManagerPermissionMain(widget.token);
      ...
      Column(
        ...
        children: [
                ...
                child: Column(
                  ...
                  children: [
                    const Padding(
                      ...
                      child: Text('Storage Status',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                    ),
                          ...
                          Column(
                            ...
                            children: [
                              LinearPercentIndicator(
                                ...
                                percent: double.parse(fileManagerPermissionMain!.data!.percentageComplete.toString()),
                                animateFromLastPercent: true,
                                center: const Text(""),
                                progressColor:double.parse(fileManagerPermissionMain!.data!.percentageComplete.toString())>0.8? Colors.red:Colors.green
                              ),
                              const SizedBox(height: 5,),
                               Padding(
                                padding: const EdgeInsets.only(left: 10),
                                child: Text(fileManagerPermissionMain!.data!.totalStorage.toString()),
                              )
                            ],
                          ),
                        ],
          ...
          const Padding(
            ...
            child: Text('My Drive',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold,color: Colors.grey),),
          ),
          const SizedBox(
            height: 10,
          ),
                  ...
                  onTap: () {
                    fileManagerPermissionMain!
                      ...
                      MaterialPageRoute(
                          builder: (context) =>
                              ListFiles(
                                widget.token,listFolder!.data![index].path)),
                    )
                        : _dialogue(
                        context,
                        'Open Folder');
