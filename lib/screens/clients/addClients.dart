            ...
            child: Column(
              children: [
                ...
                CheckboxListTile(
                    ...
                    value: addInvoice, // initial value of the checkbox
                ...
                InkWell(
                  ...
                  async {
                    ...
                    else if (phoneNumber.text.isEmpty)
                    {
                      ...
                      AddClientsModel object = await HttpService.addClients(body);
                          ...
                          if(addInvoice==true)
                            {
                              Navigator.push(
                                context,
                                MaterialPageRoute(
                                    builder: (context) => AddInvoice(widget.token,object.data.toString())),
                              );
                            }
                          else{
                            Navigator.push(
