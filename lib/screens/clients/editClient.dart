  ...
  getData() async {
    ...
    if (mainClientDetail != null) {
        ...
        if(mainClientDetail!.data!.additionalFields!.isNotEmpty)
          {
            for(int i=0;i<mainClientDetail!.data!.additionalFields!.length;i++)
              {
                additionalFields.add({
                  // "product_name":productName.text,
                  "field_name":mainClientDetail!.data!.additionalFields![i].fieldName,
                  "field_value":mainClientDetail!.data!.additionalFields![i].fieldValue,
                });
              }
          }
        setState(() {
                ...
                children: [
                                ...
                                ListView.builder(
                                  ...
                                  itemBuilder: (context, ind) {
                                    return InkWell(
                                      onTap: () {
                                        setState(() {
                                          postOffice.text = postal!.postOffice![ind].name.toString();
                                      ...
                                      child: SizedBox(
                                        height: 50,
                                        child: Text(
                                          postal!.postOffice![ind].name.toString(),
                            ...
                            child: Table(
                              columnWidths: {
                                ...
                                1: FixedColumnWidth(MediaQuery.of(context).size.width *
                                    0.4),
                                2: FixedColumnWidth(
                                    MediaQuery.of(context).size.width * 0.10),// Using 30%
                              },
                              children: [
                                TableRow(
                                  decoration: BoxDecoration(
                                ...
                                TableRow(
                                  ...
                                  children:  [
                                    Padding(
                                      ...
                                      child: Text(additionalFields[index]['field_name'],
                                        maxLines: 2,
                                    ...
                                    Padding(
                                      padding: const EdgeInsets.all(8.0),
                                      child: Text(
                                        additionalFields[index]['field_value'],
                                        maxLines: 2,
                                        overflow: TextOverflow.ellipsis,
                                        style: const TextStyle(fontSize: 12),
                                        textAlign: TextAlign.center,
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        additionalFields.removeWhere(
                                              ...
                                              item,
                                              ({
                                                "field_name":additionalFields[index]['field_name'],
                                                "field_value":additionalFields[index]['field_value'],
                                              })),
                                        );
                      ...
                      children: [
                        SizedBox(
                          ...
                          child: const Column(
                            ...
                            children: [
                              Text('Additional Fields',style: TextStyle(fontSize: 15,fontWeight: FontWeight.bold),),
                              SizedBox(height: 5,),
                              Text('If you require extra fields on the customer creation form, kindly generate the fields here.',
                  ...
                  InkWell(
                    onTap: () async {
                      ...
                      {
                        Common.toastMessaage('phoneNumber Name cannot be empty',
                            Colors.red);
                      }
                      else{
                        if (context.mounted) {
                        ...
                        if (object.status == true) {
                          ...
                          if(mounted){
                            Navigator.push(
                              context,
                              MaterialPageRoute(
                                  builder: (context) => EditClients(widget.token,widget.clientId)),
                            );
                          }
                        }
                        else {
